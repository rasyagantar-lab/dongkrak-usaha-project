...
**Remains:** the white-screen root cause. Reproduction lead: it needs a run longer than 25 s (storm-mode quota) or a path this test did not take; the first copied error report decides the next step.
