...
| Content length / operator instructions / audit findings | `PROJECT_KNOWLEDGE.md` "Description Is A 500-1000 Word SEO Article"; `ai-agents/content-generator.md` "Length Contract"; `ai-agents/quality-audit.md` "Length"; `server.ts` `CONTENT_WORDS` + `runContentAgent` + `runAuditAgent` |
