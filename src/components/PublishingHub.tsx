            ...
            <div className="bg-blue-50/70 border border-blue-200 rounded-xl p-5 space-y-3">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-xs rounded-xl shadow-sm transition-all shrink-0 cursor-pointer"
                >
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-4">
            ...
            {extState.fieldsDiscovered.length > 0 ? (
              ...
              <div className="p-6 bg-slate-50 border border-dashed border-slate-300 rounded-xl text-center space-y-3">
                ...
                >
                  Buka Form Input Produk DongkrakUsaha <ExternalLink className="w-3.5 h-3.5" />
                </button>
              </div>
            )}
          </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs space-y-4">
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 mb-4 space-y-4 text-xs">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 mb-2">
              ...
              <a href="https://dongkrakusaha.com/panelMember/index.php?menu=produk" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-blue-600 font-bold hover:underline">
                Buka Halaman Input Produk <ExternalLink className="w-3.5 h-3.5" />
              </a>
            </div>
