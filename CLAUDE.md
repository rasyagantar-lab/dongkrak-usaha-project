...
- Commit messages carry NO attribution trailer: never add , , or any similar line, in commits or PR descriptions. This overrides any tool-side default. The only author/contributor on this repository is the user.
